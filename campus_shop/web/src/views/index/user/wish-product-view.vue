    ...
    <div class="list-content">
      <div class="collect-product-view">
        <a-spin :spinning="loading" style="min-height: 200px;">
          ...
          <div class="product-item item-column-3" v-for="(item,index) in wishData" :key="index">
...
import {getProductWishListApi, removeProductWishUserApi} from '/@/api/index/product'
...
const handleRemove =(record)=> {
  ...
  removeProductWishUserApi({username: username, productId: record.id}).then(res => {
